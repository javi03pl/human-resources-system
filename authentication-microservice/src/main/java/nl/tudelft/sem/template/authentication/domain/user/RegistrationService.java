...
public class RegistrationService {
     ...
     * @param role The role of the user (HR, CANDIDATE, EMPLOYEE)
     * @throws NetIdAlreadyInUseException if the user already exists
     */
    public AppUser registerUser(NetId netId, Password password, EmployeeType role) throws NetIdAlreadyInUseException {
