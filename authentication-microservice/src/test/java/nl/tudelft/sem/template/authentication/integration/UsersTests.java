...
public class UsersTests {
    ...
    public void register_withValidData_worksCorrectly() throws Exception {
        ...
        final EmployeeType employeeType = EmployeeType.EMPLOYEE;
        ...
        model.setEmployeeType(employeeType.toString());
        ...
        String s = "Account (" + savedUser.getNetId().toString() + ") was created.\n";
        assertThat(s).isEqualTo(outContent.toString());
    }
    ...
    public void login_withValidUser_returnsToken() throws Exception {
        ...
        AppUser appUser = new AppUser(testUser, testHashedPassword, EmployeeType.HR);
        ...
        String s = "Account (" + appUser.getNetId().toString() + ") was created.\n";
        assertThat(s).isEqualTo(outContent.toString());
    ...
    public void login_withInvalidPassword_returns403() throws Exception {
        ...
        AppUser appUser = new AppUser(new NetId(testUser), testHashedPassword, EmployeeType.HR);
        userRepository.save(appUser);
